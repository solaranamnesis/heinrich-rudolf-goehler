...
\begin{table}[H]
    \centering
    \begin{tabular}{|p{30mm}|p{30mm}|p{70mm}|}
    \hline
        ...
        et Nicææ & --- & Lueders die dionys. künstler p. 9 tab. 2. Maurer de aris Gr. plur. Deis in commune positis 1885 p. 69 propter formann [GREEK] (C. J. G. 2771. Herm. Vol. 16, 166) Chalcedone duos titulos erectos esse censet; attamen mihi multo probabilius esse videtur concludere formam [GREEK] non modo Chalcedone sed in tota Bithynia usitatam fuisse. \\ \hline
    \end{tabular}
\end{table}
\subsection{Græcia.}
\begin{table}[H]
